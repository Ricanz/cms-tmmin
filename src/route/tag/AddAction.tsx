...
import '../../prism.css'
import { ActionRuleData, addAction, ConditionData, getParameters, getRules, getSetupKeys, KeyInterfaceData, ParametersData, RuleData, SetupKeyData } from '../req/req_config';
...
class AddAction extends Component<PropsMain, StateMain> {
    ...
    constructor(props: PropsMain) {
        ...
        this.state = {
            ...
            actionRuleData: {
                ...
                tagActionEnable: false,
                tagActionVerbose: false,
            },
            idKey: 0,
            idRule: 0,
        };
            ...
            <div style={{ marginTop: 50 }}>
              <Button
                ...
                onClick={async () => {
                  ...
                  await addAction(dataSend);
                  this.props.dispatch(showToast(true, "Success"));
                  window.history.back();
                }}
              >
                Save Action
...
export default (propt: any): any => {
    ...
    return <AddAction dispatch={dispatch} navigate={navigate} location={location} />;
};
