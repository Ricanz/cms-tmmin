...
class ActiveMember extends Component<PropsMain, StateMain> {
    ...
    componentDidMount(): void {
        this.props.dispatch(changeTitle("ActiveMember"));
    }
...
export default (): any => {
    ...
    return <ActiveMember dispatch={dispatch} navigate={navigate} />;
};
